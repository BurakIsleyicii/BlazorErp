using BlazorErp.Application.Configurations;
using BlazorErp.Application.Interfaces.Repositories;
using BlazorErp.Application.Interfaces.Services;
using BlazorErp.Application.Interfaces.Services.Account;
using BlazorErp.Application.Interfaces.Services.Identity;
using BlazorErp.Application.Interfaces.Shared;
using BlazorErp.Infrastructure;
using BlazorErp.Infrastructure.Contexts;
using BlazorErp.Infrastructure.Repositories;
using BlazorErp.Infrastructure.Services.Identity;
using BlazorErp.Infrastructure.Shared.Services;
using BlazorErp.Server.Permission;
using BlazorErp.Server.Services;
...
namespace BlazorErp.Server.Extensions
{
    public static class ServiceCollectionExtensions
    {
        ...
        public static void RegisterSwagger(this IServiceCollection services)
        {
            services.AddSwaggerGen(c =>
            {
                ...
                c.IncludeXmlComments(string.Format(@"{0}\BlazorErp.Server.xml", System.AppDomain.CurrentDomain.BaseDirectory));
